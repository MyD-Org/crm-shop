import { contratoCuotasV2 } from "@/lib/cuotas-repo"
import { bearerMatches } from "@/lib/secure-compare"

// GET /api/internal/shop/cuotas?tenant={tenants.id} — el Shop lee, por proveedor de pago, hasta
// cuántas cuotas ofrece el tenant según el monto. Contrato: platform/contracts/cuotas/v2 (schema.json).
...
export async function GET(req: Request) {
  ...
  const payload = await contratoCuotasV2(tenant)
