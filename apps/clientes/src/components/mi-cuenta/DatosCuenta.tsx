 ...
 *
 * Sin vincular no se le ofrece vincular (ni se le pregunta si ya es cliente):
 * el cliente de la tienda sólo carga sus datos de facturación. El vínculo con
 * Alegra se hace solo, por email verificado, o por el enlace directo a
 * /mi-cuenta/vincular que le pasa un operador.
 *
...
export function DatosCuenta({
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <Card title="Datos de facturación" description={descripcionFacturacion()}>
        {puedeCompletar && fv && (
      ...
      {vinculado && razonSocialVinculada && (
