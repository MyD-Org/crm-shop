 ...
 * el portal, y como todo Facturación: `accesoFacturacion`). Contado o sin
 * vínculo ⇒ 404: la sección no existe para ellos y el menú tampoco la ofrece. Sin llamadas a Alegra para listar documentos: espejo
...
export default async function CondicionesPage() {
  ...
  // El espejo dijo corriente pero no hay contacto que leer: aviso de caída, no un 404 engañoso.
